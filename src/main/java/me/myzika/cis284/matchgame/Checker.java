...
class Checker {
    ...
    public Difficulty prompt() {
        ...
        System.out.println("The first difficulty level is " + Colors.GREEN_BOLD_BRIGHT + "easy" + Colors.RESET + " which will let you play on a 2 x 2 grid where the selected pair will display for 6 seconds.");
    ...
    public String topic() {
        ...
        System.out.println(Colors.BLACK_BOLD + "The topics which you can choose from are: ");
        ...
        System.out.println(Colors.BLUE_BOLD + "3. United States Government");
        ...
        while (true) {
            ...
            if (userInput.equalsIgnoreCase("psychology") || userInput.equalsIgnoreCase("1")) {
                ...
                return "elements";
            } else if (userInput.equalsIgnoreCase("government") || userInput.equalsIgnoreCase("3")) {
                return "government";
            } else System.out.println(invalidInput);
        }
    }
